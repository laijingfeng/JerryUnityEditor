...
public class AssetRuleInspector : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        GUILayout.Space(20);
        m_CurRule.showLog = EditorGUILayout.Toggle(new GUIContent("显示日志"), m_CurRule.showLog);
        string[] names = GetNames();
        if (names != null && names.Length > 0)
        {
            m_SelectedID = EditorGUILayout.Popup("规则集合", m_SelectedID, names);
        }
